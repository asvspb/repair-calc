...
**Дата:** 2026-03-04
**Обновлено:** 2026-04-08 (v4.1 — Quick Wins + Приоритет 1 выполнены)
...
|---------|------|------|------|----------|---------|--------|
| Размер App.tsx | ~2700 | 557 | 489 | **478** | <300 | 🟡 |
| ProjectContext.tsx | — | 660 | 933 | **931** | <300 | 🔴 |
| RoomEditor.tsx | — | 896 | 900 | **900** | <400 | 🔴 |
| Покрытие тестами | ~5% | ~50% | ~55% | **~55%** | >70% | 🟡 |
| Типизация (any) | 3 | 0 | ~12 | **0** (prod) | 0 | ✅ |
| Failing тесты | 0 | 0 | 4 | **0** | 0 | ✅ |
| console.* в prod | — | — | 52 | **52** | 0 | 🟡 |
| Security issues | 🔴 | 🔴 | 🔴 | **🟢** | 🟢 | ✅ |
