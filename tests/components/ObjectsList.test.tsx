...
describe('ObjectsList', () => {
  beforeEach(() => {
    ...
    mockStoreState.deleteObject = vi.fn().mockReturnValue(true);
    mockStoreState.copyObject = vi.fn().mockReturnValue('obj-new');
  ...
  it('should call copyObject and switch to new object', () => {
    ...
    expect(mockStoreState.setActiveObjectId).toHaveBeenCalled();
  });
